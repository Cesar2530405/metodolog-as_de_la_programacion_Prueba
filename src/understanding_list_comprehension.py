# List Comprehension
"""
Una list comprehension combina el for loop y la creacion de nuevos elementos en una sola linea de codigo y tambien, automaticamente agrega el nuevo elemento a la lista, es decir, sin utilizar el append
